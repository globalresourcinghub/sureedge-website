...
export default function RetirementProjectorPage() {
  ...
  // Monthly retirement income at 4% safe withdrawal
  const annualSafeWithdrawal = futureBalance * SAFE_WITHDRAWAL_RATE;
            ...
            {!calculated ? (
              ...
              <>
                ...
                <div style={{ background: "#1a2e4a", borderRadius: "12px", padding: "24px", color: "#fff" }}>
                  <div style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>Projected Balance</div>
                  <div style={{ fontSize: "32px", fontWeight: 700, color: "#b8962e", letterSpacing: "-0.5px", marginBottom: "4px" }}>{fmt(futureBalance)}</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
                  {[
                    { label: "Total Contributed", value: fmt(totalContributed), sub: `${years} years` },
                    { label: "Investment Growth", value: fmt(totalGrowth), sub: `${returnRate}% return` },
                    { label: "Monthly Income", value: fmt(monthlySafeWithdrawal), sub: "4% rule" },
                  ].map(c => (
                    <div key={c.label} style={{ background: "#fff", borderRadius: "10px", padding: "14px", border: "1px solid #f0ede6", textAlign: "center" }}>
                      <div style={{ fontSize: "16px", fontWeight: 700, color: "#1a2e4a" }}>{c.value}</div>
                      <div style={{ fontSize: "10px", fontWeight: 600, color: "#b8962e", textTransform: "uppercase", letterSpacing: "0.6px", marginTop: "3px" }}>{c.label}</div>
                      <div style={{ fontSize: "10px", color: "#aaa", marginTop: "2px" }}>{c.sub}</div>
                    </div>
                  ))}
                </div>
