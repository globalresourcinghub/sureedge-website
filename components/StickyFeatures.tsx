...
const FEATURES = [
  {
    id: "tax",
    label: "01",
    title: "Tax returns filed right the first time.",
    desc: "Federal, state, and multi-year returns prepared by a licensed CPA — not a software algorithm. Every deduction reviewed.",
    bullets: ["W-2, freelance, investor & retiree returns", "Multi-state filers handled", "E-filed & tracked to acceptance"],
    mock: <TaxMock />,
  },
  {
    id: "books",
    ...
    desc: "Monthly reconciliation and categorization via QuickBooks. Your finances, always audit-ready and clearly understood.",
    bullets: ["Monthly transaction reconciliation", "QuickBooks managed for you", "P&L, balance sheet, cash flow"],
    mock: <BooksMock />,
  },
  {
    id: "irs",
    label: "03",
    title: "IRS notices handled for you.",
    desc: "Enrolled Agent representation before the IRS. Audits, CP notices, appeals — we respond while you focus on your life.",
    bullets: ["Direct EA representation", "Audits, notices & appeals", "Average resolution: 18 days"],
    mock: <IrsMock />,
  },
];
