    ...
    <div style={{ display: "flex", minHeight: "340px" }}>
      ...
      <div style={{ flex: 1, background: "#faf9f6", display: "flex", flexDirection: "column", justifyContent: "center", padding: "44px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
          {[
            ["Enrolled Agent", "Licensed Enrolled Agent on our team — full tax preparation and IRS representation in one place."],
            ["Direct Access to Your Tax Pro", "You speak directly with us. No call centers or junior staffers."],
